...
This is a demo application crate showing how to use `i18n-runtime` and `i18n-gen`.
...
- Planned: Add CI example for running `i18n-gen` automatically.
...
- Demonstration of **generated PHF mode**:
  - Uses `i18n-gen` output in `src/generated_i18n/`.
